...
var createInventoryController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var inventoryCategory, category, inventory, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                return [4 /*yield*/, InventoryCategory_1.InventoryCategory.find({ name: req.body.inventoryCategory })];
            case 1:
                inventoryCategory = _a.sent();
                console.log('inventory category', inventoryCategory.length);
                if (!(inventoryCategory.length === 0)) return [3 /*break*/, 3];
                category = new InventoryCategory_1.InventoryCategory({
            ...
            case 4:
                _a.sent();
                res.json({ msg: 'Inventory created successfully', inventory: inventory });
                return [3 /*break*/, 6];
            case 5:
                err_1 = _a.sent();
